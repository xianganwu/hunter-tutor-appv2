...
export function ScoreReport({ report }: ScoreReportProps) {
  ...
  return (
    <div className="max-w-3xl mx-auto py-8 px-4 space-y-8">
      ...
      {/* Overall Score */}
      <div className="rounded-2xl border-2 border-blue-200 dark:border-blue-800 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 p-6 text-center">
        ...
        <div className="mt-3 inline-block rounded-full bg-blue-100 dark:bg-blue-900/40 px-4 py-1">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-5">
          ...
          <div className="flex items-baseline gap-2">
            <span className={`text-3xl font-bold ${writing.score >= 7 ? "text-green-600" : writing.score >= 5 ? "text-amber-600" : "text-red-500"}`}>
              {writing.score}
            </span>
          ...
          {writing.strengths.length > 0 && (
            <div className="mt-2">
              ...
              <ul className="text-xs text-gray-600 dark:text-gray-400 mt-0.5">
      ...
      {/* Recommendations */}
      <div className="rounded-xl border-2 border-green-200 dark:border-green-800 bg-green-50 dark:bg-green-900/10 p-5 space-y-3">
...
function TimeBar({
  ...
  const verdictColors = {
    rushed: "text-red-600 dark:text-red-400",
